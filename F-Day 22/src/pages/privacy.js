	...
	<div>
      ...
      <ul>
        ...
        <li>
          ...
          "Us" or "Our" in this Agreement) refers to Share Your Bite.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Share Your Bite, accessible from{' '}
          <a
            href="www.shareyourbite.com"
            rel="external nofollow noopener"
            target="_blank"
          >
            www.shareyourbite.com
          </a>
        </li>
        <li>
      ...
      <p>Your mobile device unique ID, the IP address of Your mobile device, Your mobile operating system, the type of mobile Internet browser You use, unique device identifiers, and other diagnostic data.</p>
...
<ul>
  ...
  <li>
    <strong>To provide You</strong> with news, special offers, and general information about other goods, services, and events that we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information.
  </li>
  <li>
...
<ul>
  <li>By email: www.shareyourbite.com</li>
</ul>
</div>
    </div>
	<Footers></Footers>
